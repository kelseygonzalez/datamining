...
#Significant changes in relative reachability allow for clusters to manifest themselves hierarchically as ‘dents’ in
# the ordering structure. The hierarchical representation ExtractXi can, as opposed to the ExtractDBSCAN method, produce clusters of varying densities.
