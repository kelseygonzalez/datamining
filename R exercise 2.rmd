...
qqPlot(data2$pop, main = "Life Expectancy QQ Plot")
data2[48, "Population"] <-mean(data2$pop,  na.rm = TRUE)
symnum(cor(data2[4:20], use = "complete.obs"))
```

We found that High GDP correlates to higher Life Expectancy Rates. The same goes for GDP and Percentage Expenditure. Under 5 deaths also correlates with infant deaths.  
