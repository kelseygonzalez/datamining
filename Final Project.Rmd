...
ISO3166$name[ISO3166$name == "Moldova, Republic of"] <- "Rep_Moldova"
ISO3166$name[ISO3166$name == "Korea, Republic of"] <- "Rep_Korea"
ISO3166$name[ISO3166$name == "Korea (Democratic People's Republic of)"] <- "Dem_Peoples_Rep_Korea"
ISO3166$name[ISO3166$name == "Congo, Democratic Republic of the"] <- "Dem_Rep_Congo"
ISO3166$name[ISO3166$name == "North Macedonia"] <- "Macedonia"
ISO3166$name[ISO3166$name == "Tanzania, United Republic of"] <- "Tanzania"
```
...
# not sure about this one, just experimenting
